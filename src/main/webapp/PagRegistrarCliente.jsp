                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input value="${cliente.telefono}" type="tel" class="form-control" required="" name="telefono" placeholder="Ingrese su teléfono"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input value="${cliente.correo}" type="email" class="form-control" required="" name="correo" placeholder="Ingrese su correo electrónico"/>
                                        </div>
                                    </div>
                                </div>
